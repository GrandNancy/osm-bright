...
#roads_med[zoom>=9][zoom<=10] {
  [type='motorway'], [type='motorway_link'] { line-color:@motorway_line }
  [type='trunk'], [type='trunk_link'] { line-color:@trunk_line; }
  ...
  [zoom=9] {
    ...
    [type='primary'],[type='secondary'],[type='motorway_link'],[type='trunk_link'] { line-width:0.6; }
  }
  [zoom=10] {
    [type='motorway'],[type='trunk'] { line-width:1.8; }
    [type='primary'],[type='secondary'],[type='motorway_link'],[type='trunk_link'] { line-width:0.8; }
  }
}
...
@rdz11_maj:1.6; @rdz11_med:0.8; @rdz11_min:0;
@rdz12_maj:2.5; @rdz12_med:1.2; @rdz12_min:0;
@rdz13_maj:3; @rdz13_med:1.5; @rdz13_min:0.5;
@rdz14_maj:6; @rdz14_med:4; @rdz14_min:2;
@rdz15_maj:8; @rdz15_med:6; @rdz15_min:3;
@rdz16_maj:10; @rdz16_med:8; @rdz16_min:6;
@rdz17_maj:14; @rdz17_med:12; @rdz17_min:10; // @rdz17_maj:14; @rdz17_med:12; @rdz17_min:10;
@rdz18_maj:18; @rdz18_med:15; @rdz18_min:13; // @rdz18_maj:20; @rdz18_med:17; @rdz18_min:14;
@rdz19_maj:20; @rdz19_med:17; @rdz19_min:14; // on agrandira les bords plutôt qu'élargir la route

@railz11:0.4; @railz12:0.6; @railz13:1; @railz14:1.2; @railz15:1.8; @railz16:2.2; @railz17:4; @railz18:5.5; @railz19:8;

/* ---- Casing ----------------------------------------------- */

#roads_high::outline[zoom>=11],
#tunnel[render='1_outline'][zoom>=11],
#bridge[render='1_outline'][zoom>=11]{
  /* -- colors & styles -- */
  line-cap:round;
  [bridge=1],
  [tunnel=1] {
  ...
  /* -- widths -- */
  [zoom=11] {
    [stylegroup='motorway'] { line-width:@rdz11_maj + 1.5; }
  ...
  [zoom=13] {
    [stylegroup='motorway'] { line-width:@rdz13_maj + 1; }
  ...
  [zoom=15] {
    ...
    [stylegroup='railway']  { line-width:@railz15 + 2; }
  }
  [zoom=16] {
    ...
    [stylegroup='railway']  { line-width:@railz16 + 2; }
  }
  [zoom=17] {
    [stylegroup='motorway'] { line-width:@rdz17_maj + 4; }
    [stylegroup='mainroad'] { line-width:@rdz17_med + 3.5; }
    [stylegroup='minorroad']{ line-width:@rdz17_min + 3; }
    [stylegroup='service']  { line-width:@rdz17_min / 3 + 3; }
    [stylegroup='noauto']   { line-width:@rdz17_min / 4 + 5; }
    [stylegroup='railway']  { line-width:@railz17 + 5; } // 3 + 4
  }
  [zoom=18] {
    [stylegroup='motorway'] { line-width:@rdz18_maj + 6; }
    [stylegroup='mainroad'] { line-width:@rdz18_med + 6; }
    [stylegroup='minorroad']{ line-width:@rdz18_min + 5.5; }
    [stylegroup='service']  { line-width:@rdz18_min / 3 + 8.5; }
    [stylegroup='noauto']   { line-width:@rdz18_min / 4 + 8; }
    [stylegroup='railway']  { line-width:@railz18 + 9; }
  }
  [zoom>=19] {
    [stylegroup='motorway'] { line-width:@rdz19_maj + 7; }
    [stylegroup='mainroad'] { line-width:@rdz19_med + 7; }
    [stylegroup='minorroad']{ line-width:@rdz19_min + 6.5; }
    [stylegroup='service']  { line-width:@rdz19_min / 3 + 6.5; }
    [stylegroup='noauto']   { line-width:@rdz19_min / 4 + 9; }
    [stylegroup='railway']  { line-width:@railz19 + 10; }
  }
}
...
#bridge[render='3_inline'][zoom>=11]{
  ...
  [stylegroup='railway'] { 
    ...
    [type='tram'] { line-color:@rail_tram*1.2;}
    [type='subway'] { line-opacity:0.67; }
    // line-dasharray:1,1;
    [zoom>15] {
      	line-dasharray:1,2;
      	line-color:@rail_line_dash;
        [type='tram'] { line-color:@rail_tram; line-dasharray:1,1;}
    	[type='subway'] { line-opacity:0.67; }
    }
  ...
  [zoom=13] {
    ...
    [stylegroup='railway']  { line-width:@railz13; }
  }
  [zoom=14] {
    ...
    [stylegroup='railway']  { line-width:@railz14; }
  }
  [zoom=15] {
    ...
    [stylegroup='railway']  { line-width:@railz15; }
  }
  [zoom=16] {
    ...
    [stylegroup='railway']  { line-width:@railz16; }
  }
  [zoom=17] {
    ...
    [stylegroup='railway']  { line-width:@railz17; }
  }
  [zoom=18] {
    ...
    [stylegroup='railway']  { line-width:@railz18; }
  }
  [zoom>=19] {
    ...
    [stylegroup='noauto']   { line-width:@rdz19_min / 4; line-dasharray:4,3; }
    [stylegroup='railway']  { line-width:@railz19; }
  }
}
